...
/**
 * elf_checker - This checks if a particular file is an ELF file.
 * @e_ident: This is a pointer to an array which contains ELF magic numbers.
 *
...
/**
 * magic_print - This prints the magic numbers of an ELF header.
 ...
 * @e_ident: This ia a pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * print_abiversion - This prints the ABI version of an ELF header.
 ...
 * @e_type: This represents the type of ELF.
 * @e_ident: This is a pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * entry_point - This prints the entry point of an ELF header.
 ...
 * @elf: This indicates the file descriptor of the ELF file.
 *
...
/**
 * main - This displays the information which is contained
 *        in the ELF header at the starting point of an ELF file.
 * @argc: This represents the number of arguments which is supplied to the program.
 * @argv: This is an array of pointers to these arguments.
 *
